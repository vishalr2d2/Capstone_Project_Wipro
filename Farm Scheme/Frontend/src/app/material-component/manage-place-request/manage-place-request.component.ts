...
@Component({
  selector: 'app-manage-place-request',
  templateUrl: './manage-place-request.component.html',
  styleUrls: ['./manage-place-request.component.scss']
})
export class ManagePlaceRequestComponent implements OnInit {
  ...
  tableData() {
    this.sellService.getSellRequestByFarmer(localStorage.getItem('id')).subscribe((response: any) => {
