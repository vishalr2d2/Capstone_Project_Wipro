...
@Component({
  selector: 'app-view-sold-crop-history',
  templateUrl: './view-sold-crop-history.component.html',
  styleUrls: ['./view-sold-crop-history.component.scss']
})
export class ViewSoldCropHistoryComponent implements OnInit {
  displayedColumns: string[] = ['cropType', 'cropName', 'fertilizerType', 'quantity', 'soilPhCertificate','fullName','amount'];
  dataSource: any;
  length1: any;
  responseMessage: any;
